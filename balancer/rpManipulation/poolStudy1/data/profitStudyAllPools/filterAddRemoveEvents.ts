...
/**
 * Keep ADD/REMOVE from poolEvents; Balancer returns human-readable `amount` strings (no wei scaling).
 * Filter by sender (case-insensitive). Sort by block, then tx, then id for stability.
 */
